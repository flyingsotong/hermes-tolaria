...
In November 2012, [I wrote a blog post](https://ghost.onolan.org/?ref=john.onolan.org) pitching my answer to that question. I called it Ghost, and it was made up of a few core ideas:
...
I roped in my best friend and one of the most talented developers I've ever known - Hannah Wolfe - as co-founder and CTO, and in April 2013 we launched [a Kickstarter campaign](https://ghost.onolan.org/?ref=john.onolan.org) to fund the project and get it started.
...
Nobody is required to use our hosting. In fact, the majority of Ghost websites in the world do _not_ use [Ghost(Pro)](https://ghost.org/pricing/?ref=john.onolan.org) — but the ones that do, directly fund the project for the benefit of everyone.

We've grown slowly but steadily since then, only hiring when we could afford to, and today Ghost has a [full-time team](https://ghost.org/about/?ref=john.onolan.org) of 30+ people working on it.
...
For instance: In the US, non-profits are heavily regulated in their operations, and exempt from income tax. In many other places, there are different kinds of non-profit structures that can operate more freely, but are _not_ tax-exempt.
...
People often think that "non-profit" means that the company can't make a profit. It actually means that the company doesn't have any _owners_ who can personally take the profits. Any revenue earned can only be reinvested.
...
[What Happens When Private Equity Takes Over a HospitalNew analysis shows alarming increase in patient complicationsHarvard Medical SchoolJAKE MILLER](https://hms.harvard.edu/news/what-happens-when-private-equity-takes-over-hospital?ref=john.onolan.org) [The rising danger of private equity in healthcare - Lown InstituteEmerging evidence shows that the influence of private equity in healthcare demands attention. Here’s what’s in the latest research.Lown InstituteJudith Garber](https://lowninstitute.org/the-rising-danger-of-private-equity-in-healthcare/?ref=john.onolan.org)
...
The purpose of this is twofold: First, to ensure that Ghost remains accountable to its ecosystem, and second, to bring in a wider range of perspectives that can guide the project. We'd like a board that includes people who deeply understand open source, publishing, journalism and technology, ensuring that Ghost’s mission is protected and upheld over the long term. We also intend to have some seats be actively elected by the Ghost community itself — something which other open source projects, like [Drupal](https://www.drupal.org/association/board?ref=john.onolan.org), provide a great example of.
...
In short: No '[BDFL](https://en.wikipedia.org/wiki/Benevolent_dictator_for_life?ref=john.onolan.org)'.

Another idea I'm excited to explore is formal Ghost Foundation membership with both individual and company tiers. This is something that organisations like the [Connected Standards Alliance](https://csa-iot.org/?ref=john.onolan.org) do very well. As a member, you get benefits such as voting rights on policy decisions, access to licensing and certifications, as well as a community of others who are invested in the future of what everyone is building together. By inviting people within our ecosystem to help shape how we do things, we hope to ensure that Ghost continues to embody the values we set out to champion when we first started.

We also intend to continue to increase transparency around how we work, how decisions get made, and who makes them. We already publish [public revenue data and live statistics](https://ghost.org/about?ref=john.onolan.org), and we have many ideas for ways to open this up further and do more which we intend to pursue.
...
If you're a webhost, agency or developer, we'd love to invite you to [explore](https://ghost.org/docs/?ref=john.onolan.org) joining us and building within the Ghost ecosystem. There's a large and increasing amount of demand from [publishers](https://ghost.org/explore/?ref=john.onolan.org) moving to Ghost who are looking for [themes](https://ghost.org/themes/?ref=john.onolan.org), [integrations](https://ghost.org/integrations/?ref=john.onolan.org), [hosting](https://ghost.org/docs/install/?ref=john.onolan.org), and [services](https://ghost.org/experts/?ref=john.onolan.org).

With Ghost's core team remaining intentionally small, we don't just _want_ you to succeed. In order for our ecosystem to thrive: We need you to.
