...
**3. Establishes and maintains agreements** — partners with the client and relevant stakeholders to create clear agreements about the coaching relationship, process, plans and goals.
...
**4. Cultivates trust and safety** — partners with the client to create a safe, supportive environment that allows the client to share freely.
...
What are the things that can lead to stress or resentment?

1. Status: How do others see me?
2. Certainty: How likely will this happen, or not?
3. Autonomy: Do I have control of this?
4. Relatedness: Am I part of the "in" group or outside of it?
5. Fairness: Am I treated fairly as others?
...
2. Bad habits — drinking, not taking care of self
3. Triggers fights with others

Can you identify it? Sad, shame, disgust, anger, fear, surprise, joy, love, trust.

What can you do about it?

1. Normalize, embrace, accept
2. Change your interpretation of the event
3. Find positive meaning
4. Be present and understand what's happening

How can you recover? Sleep, exercise, food, sunshine, positive mindset.

---

**Meaning (with Damien Tan)**

- Why do you need meaning?
- Why does this matter to you?
- How does that affect you?
- How do you define meaning?
- Purpose, control, value alignment, self-worth
- How does this align with your values? Which values?

**Change (with Bryan Goh)**

- Helping people deal with unwanted change
- Help them shift mindsets, attitudes, values (Mav-erick)

**Change cycle questions — help them see themselves in this change process so they can see light at the end**
...
3. Emerging (the beginning of acceptance): What are you curious about in this change? How and where might you shape the impact of this change? How might you be resisting this change? What questions do you have about this change? How will knowing the answers to the questions help? What might be possible from here? What is the best that could happen?
4. New relationship: What do you have to accept? What do you have to let go of? What now feels good about this change? What might now be possible? What can you focus on now? How can you take this forward? What have you learned from this process?

---

**Email recording link to:** tunasinger@gmail.com, theresalyetan@gmail.com

**July 27, 2023 — end of project reporting**

- Clear the coaching report with the coachee — have them read it
- Send the report off, but cc the coachee
- Or get the coachee to write their own report

**Learning panel with Suzanne Voo and Brian Liu**

- Defining success also includes what you got out of it as a coach — what do you learn? How did you grow? (Suzanne)
- It's important to have a set of tools, not just coaching — Brian got into this business first as a facilitator
- Brian — look at yourself as a coach: what do I need, how do I extend my capabilities, who am I as a person — and derive your sweet spots from there
- Be needs focused — send your energy toward things and people you care most about (Brian)
- No pressure — take it slow and see where it goes (Suzanne)
- Coaching is about service — focus on that and the word of mouth will happen (Brian)

**My thoughts**

- ICF certification's most important feature: safety and confidentiality for clients

**Useful feedback from Barbara**

- I'm offering solutions. Don't. ICF doesn't allow that.
- Think of this as a deck of cards that the coachee is putting down on the table. You can take any card and talk about it... but nothing else outside of that

**July 28, 2023**

- Stick with the topic for a little bit longer than you're comfortable... and the answer may come (Tanja)