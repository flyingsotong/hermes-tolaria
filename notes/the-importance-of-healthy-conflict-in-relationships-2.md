...
**Smart summary:** The thread provides tips on how to navigate conflict in a healthy way. It discusses how many of us have experienced conflict that leads to negative outcomes, and how this is often due to unhealthy dynamics that we learned from our parent figures. The thread outlines how healthy conflict should be approached, with the goal of deeper understanding and not winning. It also discusses how our nervous system can dictate our ability to communicate, and how important it is to be aware of this when in conflict.
...
1. Active listening: active listening is the act of truly being present to what another person says.
...
1. Reflection: we all have a deep need to be heard. When your partner shares, before stating your side, reflect on what they've said.
...
1. Nervous System Awareness: when our nervous system is in: fight flight freeze or fawn, we lose the ability to access the logical part of our brain that allows for clear communication.
...
1. Solution focused: in dysfunctional relationships, there's deep need for control.
...
1. Affirm and reassure: conflict is scary for all of us. It can help to hug each other, tell each other you love each other, or hold hands in silence during or after the issue.
note: speak directly to what you need "I could use reassurance right now."
1. Stop using absolutes: "You always do" "You never do" "Not surprised, you did that again!" are all statements that put our partner on the defensive.
Speak for yourself.
