...
- Type: [Entrepreneurship 2](Year%202%20in%20Review%20They%20Got%20Acquired%20in%202023%20%28Alexis%20Grant%29/Entrepreneurship%202)

- Alexis Grant

- Summary: The author is launching a data platform focused on low-to-middle-market online business deals and buyers, a project two years in the making due to underestimating the time needed for core business functions and a strategic pause. In the second year, revenue doubled, primarily from sponsorships and a grant, with all revenue reinvested into the business. The author did not take a salary for the second consecutive year, relying on their spouse's income and past savings. Successful strategies included content operations, reports, sponsorships, a course, audience segmentation, brand awareness, a reliable team, and helping founders sell. Challenges included slower audience growth and unreliable referral revenue. Failed revenue experiments included memberships, M\&A coaching, and workshops, leading to a focus on the data platform. Year three is seen as make-or-break, with plans to launch the platform quietly in April and more broadly later, while continuing content operations. The author works 25 hours a week and aims to grow strategically, delegate, and be patient.
...
Revenue & profit in Year 2 While there are so many other pieces that make a business successful (I talk about some of those in our Year 1 review), I’m starting this report with revenue and profit because now that we’re two years in, it’s our No. 1 KPI.
...
What worked for They Got Acquired in Year 2 Going into Year 2, we’d set a great foundation for this media business. The content operation was flowing smoothly (though I was still doing most of the editing myself), and we had product-market fit in terms of the value we provided to readers.
...
1. Reports: Our reports were a real hit this year, from so many angles. They brought us new subscribers, drove high-quality leads for our sponsors, and a number of founders told me they used them as data points to make important decisions for their business.
...
9 Agency Deals 13 Newsletter Deals (our most-downloaded report this year) 8 E-commerce Deals 53 Female Founders Who Sold a Business 14 Companies That Sold With a Contractors-Only Model For our first two reports in 2022, we gave away a limited version and charged for the full version. But this year, we shifted to a different model, selling one or two sponsorships for each report, then offering the reports for free to our audience.
...
1. Sponsorships: We worked with some great sponsors this year, and I’m proud of the value we delivered as leads and brand awareness.
...
CEX: Content Entrepreneurs Expo (held in April in Cleveland) AMO: A Media Operator (held in October in New York City) Rhodium (held in October in Las Vegas) Hampton (a community that’s primarily online)

The organizers behind CEX surprised me with a Content Entrepreneur of the Year Finalist award (2023) 9) Saying no: I did well this year choosing what not to do, which opened up so much time and focus for true priorities. For example, over the last two months of the year, I decided to say no to most founder call requests, which opened hours to work on our data platform. Even with that break, I did about 75 free calls with founders this year!

1. Helped founders sell: I saved the best for last. We helped a lot of founders sell their business this year or position to sell in future years through our newsletters, reports and referrals. This is, by far, the most gratifying part of running this business: watching founders reap the rewards of what they’ve built. This continues to be our mission, and it feels good to fulfill it.
...
1. Referrals: I talk with a lot of founders who want to sell their business in the next few years, and when it makes sense, we refer them to one of our M\&A advisor partners. So we put them in touch with a broker or advisor who can help them sell their business, and if they end up selling with that firm, we get a commission.
...
The leads take a long time (in some cases, years) to convert Once we make the referral, we can’t control or even influence the outcome Many of the leads will never convert, if the founder decides not to sell, finds a buyer on their own, or decides to work with a different advisor In other words, it’s inconsistent and unreliable. I’m still hopeful that more referral commissions will come our way in 2024, but we can’t count on this being fruitful.
...
What was challenging or didn’t work in 2023 The biggest challenge this year was the same as last year: the juggle.
...
1. Workshops: At one point in the year, I went hard down the path of offering workshops about how to prepare your business for a sale. I even sent out a launch email and built a list of founders who were interested.
...
Looking ahead to Year 3: 2024 That brings me back to the one thing we’re focused on for Year 3: our data platform featuring buyers and deals.
...
[Entrepreneurship](Year%202%20in%20Review%20They%20Got%20Acquired%20in%202023%20%28Alexis%20Grant%29/Entrepreneurship)