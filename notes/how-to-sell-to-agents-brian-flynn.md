...
Coase's 1937 insight: firms exist because transaction costs make markets inefficient. AI agents are collapsing the search and evaluation layer to near-zero. When search costs disappear, the default shifts from "build in-house" to "buy on the open market." The buyers are software with budgets.
